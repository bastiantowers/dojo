...
describe("Dojo 12", () => {
    it('Dado un conjunto de Aulas disponibles, se solicita una de ellas con capacidad para al menos 10 personas', () => {
        ...
        let classRooms = [ new ClassRoom('Lab A', 5, 'Aula: Lab A'), new ClassRoom('Lab B', 15, 'Aula: Lab B') ];
    ...
    it('La gente de arquitectura necesita además de capacidad en el aula, que la misma cumpla con cierta cantidad de metros cuadrados para poder exponer sus maquetas.', () => {
        ...
        // Ej:  [
        // {nombre:”Lab A”, capacidad:5, m2:’10},
        // {nombre:”Lab B”, capacidad:15, m2:20},
        // {nombre:”Lab C”, capacidad:15, m2:50}]   -> capacidad 10, 30m2 -> "Aula: Lab C"
        let classRooms = [
            new ClassRoom('Lab A', 5, 'Aula: Lab A', 10),
            new ClassRoom('Lab B', 15, 'Aula: Lab B', 20),
            new ClassRoom('Lab C', 15, 'Aula: Lab C', 50)
        ];

        const classRoomCalendarFinder = new ClassRoomCalendarFinder();
        const availableClassroom = classRoomCalendarFinder.getFreeClassroomByCapacityAndM2(classRooms, 10, 30);
        chai.expect(availableClassroom.label).to.equal('Aula: Lab C');
    });
